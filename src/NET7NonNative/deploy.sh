...
docker run --volume /home/ec2-user/serverless-dotnet-demo/src/NET7Native/:/workingdir --name net7-native-build-container -i net-7-native-builder dotnet publish /workingdir/NET7Native.sln -r linux-x64 -c Release
